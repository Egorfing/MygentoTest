...
function ModalSuccess({active, setActive}) {
  return (
    <div className={active ? 'modal active' : 'modal'} onClick={() => setActive(false)}>
      <div className="infoSuccess">
        <h3>Политика конфиденциальности</h3>
        <div className="window">
        <p><span className="bold">1. Общие положения</span><br/>
...
<span className="bold">2. Основные понятия, используемые в Политике</span><br/>
...
<span className="bold">3. Оператор может обрабатывать следующие персональные данные Пользователя</span><br/>
...
<span className="bold">4. Цели обработки персональных данных</span><br/>
...
<span className="bold">5. Правовые основания обработки персональных данных</span><br/>
...
<span className="bold">6. Порядок сбора, хранения, передачи и других видов обработки персональных данных</span><br/>
...
<span className="bold">7. Трансграничная передача персональных данных</span><br/>
...
<span className="bold">8. Заключительные положения</span><br/>
...
8.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу httpsː//thismywebsite·com/privacy/.</p>
        ...
        <button className="btnAgree" onClick={() => setActive(false)}>Я согласен</button>
      </div>
    </div>
  );
}
